...
llvm::Value *PrintVisitor::VisitPostMemberDotExpr(PostMemberDotExpr *postMemberDot)
{
    postMemberDot->left->Accept(this);
    *out << ".";
    *out << postMemberDot->member.name;
    return nullptr;
}

llvm::Value *PrintVisitor::VisitPostMemberArrowExpr(PostMemberArrowExpr *postMemberArrow)
{
    postMemberArrow->left->Accept(this);
    *out << "->";
    *out << postMemberArrow->member.name;
    return nullptr;
}
