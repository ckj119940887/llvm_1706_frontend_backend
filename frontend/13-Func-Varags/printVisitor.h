...
public:
    ...
    llvm::Value *VisitStringExpr(StringExpr *factorExpr) override;
    ...
    llvm::Value *VisitPostMemberDotExpr(PostMemberDotExpr *postMemberDot) override;
    llvm::Value *VisitPostMemberArrowExpr(PostMemberArrowExpr *postMemberArrow) override;
    llvm::Value *VisitPostFuncCall(PostFuncCall *postMemberArrow) override;
