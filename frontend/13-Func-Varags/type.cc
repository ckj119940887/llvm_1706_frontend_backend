...
CFuncType::CFuncType(std::shared_ptr<CType> retType, std::vector<Param> &params, llvm::StringRef name, bool isVarArg) : CType(CType::TY_Func, 1, 1), retType(retType), params(params), name(name), isVarArg(isVarArg)
{
}